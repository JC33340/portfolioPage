...
export default function Projects(){
    ...
    const projectInfo:{
        ...
        {name:"CV-Builder",description:"Converts user input into a downloadable PDF",pictures:[cvBuilder1,cvBuilder2],youtubeLink:undefined,githubLink:"https://github.com/JC33340/CVbuilder.git",technologiesUsed:["react","HTML","CSS"], Link:'https://cvbuilder-d69.pages.dev/'},
