...
export default function Projects(){
    ...
    const projectInfo:{
        ...
        {name:"Chat-App", description:"Websocket chat app",pictures:[chatapp1,chatapp2],youtubeLink:"https://youtu.be/IUKFniJzdYs",githubLink:"https://github.com/JC33340/chat.git",technologiesUsed:["django","websocket","HTML","CSS"]},
        {name:"CV-Builder",description:"Converts user input into a downloadable PDF",pictures:[cvBuilder1,cvBuilder2],youtubeLink:"https://youtu.be/0OuBKHL8CGc",githubLink:"https://github.com/JC33340/CVbuilder.git",technologiesUsed:["react","HTML","CSS"]},
